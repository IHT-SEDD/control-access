...
$triggerActiveClass = $isActive
? 'border-b-2 border-blaze-orange text-eerie-black'
: 'text-sonic-silver hover:text-eerie-black';
@endphp

<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    <button type="button" @click="open = !open" class="group dropdown-trigger {{ $triggerActiveClass }}"
        x-bind:class="open ? 'text-eerie-black' : ''">
        {{ $trigger }}
    </button>
